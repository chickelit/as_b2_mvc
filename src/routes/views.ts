...
viewRouter.get("/dashboard/products", (req, res) => res.render("dashboard/products", { layout: "_layout" }));
viewRouter.get("/dashboard/products/create", (req, res) => res.render("dashboard/products/create", { layout: "_layout" }));
viewRouter.get("/dashboard/products/create", (req, res) => res.render("dashboard/products/create", { layout: "_layout" }));
